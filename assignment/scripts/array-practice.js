...
let favoriteFoods = ['japanese curry', 'ramen', 'tacos', 'clam chowder']
...
console.log('The first color removed is', firstColor);
...
let sortedGems = gems.sort();
sortedGems = gems.reverse();
console.log(`The gems are sorted in reverse alphabetical order: ${sortedGems}`);
...
let gemString = `${gems[0]} and ${gems[1]} and ${gems[2]} and ${gems[3]} and ${gems[4]} and ${gems[5]}`;
